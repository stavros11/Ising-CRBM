...
## Observables ##
kI, kF = 5, 2000
obs = np.load('Observables/Critical/CRBML8_W8K64BS50LR0.00100_VER2_EP500/k%d_%d.npy'%(kI, kF))
...
def plot_quantity(q=0, figsize=(10, 6)):
...
def plot_errors(q=0, figsize=(10, 6)):
    plt.figure(figsize=figsize)
